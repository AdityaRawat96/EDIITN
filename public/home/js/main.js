function Launcher() {
    ...
    $(".admission-banner__notification--slider")
        .not(".slick-initialized")
        .slick({
            dots: false,
            infinite: true,
    ...
    $(".howToApply-steps .carousel-indicators button:nth-child(1)").on(
        "click",
        function () {
            $(this).addClass("active");
            $(".howToApply-steps .carousel-item:nth-child(1)").addClass(
                "active"
            );
            $(
                ".howToApply-steps .carousel-indicators button:nth-child(2), .howToApply-steps .carousel-indicators button:nth-child(3)"
            ).removeClass("active");
            $(
                ".howToApply-steps .carousel-item:nth-child(3), .howToApply-steps .carousel-item:nth-child(2)"
            ).removeClass("active");
        }
    );
    $(".howToApply-steps .carousel-indicators button:nth-child(2)").on(
        "click",
        function () {
            $(this).addClass("active");
            $(".howToApply-steps .carousel-item:nth-child(2)").addClass(
                "active"
            );
            $(
                ".howToApply-steps .carousel-indicators button:nth-child(1), .howToApply-steps .carousel-indicators button:nth-child(3)"
            ).removeClass("active");
            $(
                ".howToApply-steps .carousel-item:nth-child(1), .howToApply-steps .carousel-item:nth-child(3)"
            ).removeClass("active");
        }
    );
    $(".howToApply-steps .carousel-indicators button:nth-child(3)").on(
        "click",
        function () {
            $(this).addClass("active");
            $(".howToApply-steps .carousel-item:nth-child(3)").addClass(
                "active"
            );
            $(
                ".howToApply-steps .carousel-indicators button:nth-child(1), .howToApply-steps .carousel-indicators button:nth-child(2)"
            ).removeClass("active");
            $(
                ".howToApply-steps .carousel-item:nth-child(1), .howToApply-steps .carousel-item:nth-child(2)"
            ).removeClass("active");
        }
    );
    ...
    $(".c-popup").on("click", function () {
        ...
        $("body")
            .addClass("modal-open")
            .css("overflow", "hidden", "padding-right", "17px");
    });
    ...
    $(".btn-close").on("click", function () {
        ...
        $("body")
            ...
            .css("overflow", "inherit", "padding-right", "0");
    });
