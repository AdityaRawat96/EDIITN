        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-7">
                        <!--begin::Label-->
                        <label class="col-lg-4 fw-semibold text-muted">Email<i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Phone number must be active"></i></label>
                        <!--end::Label-->
                        <!--begin::Col-->
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="d-flex flex-wrap align-items-center mb-10">
                            ...
                            <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                                <!--begin::Form-->
                                <form class="form" action="{{route(Auth::user()->role.'.user.updatePassword', $user->id)}}" id="kt_signin_change_password" method="POST">
                                    @csrf
                                    <div class="row mb-1">
                                        <div class="col-lg-4">
                                            <div class="fv-row mb-8" data-kt-password-meter="true">
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <!--begin::Meter-->
                                                    <div class="d-flex align-items-center mt-3 mb-3" data-kt-password-meter-control="highlight">
