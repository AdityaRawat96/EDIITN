                    ...
                    <div class="d-flex flex-stack mb-5 table-toolbar">
                        ...
                        <div class="table-search d-flex align-items-center position-relative my-1">
                            ...
                            <span class="svg-icon svg-icon-1 position-absolute ms-6">
                                <svg width="24" height="24" viewApplication="0 0 24 24" fill="none"
                        ...
                        <div class="d-flex justify-content-end gap-2" data-kt-docs-table-toolbar="base">
                                    ...
                                    <div class="px-7 py-5">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <div>
                                                <select multiple="multiple"
                                                    class="form-select form-select-solid filter-option"
                                        ...
                                        <div class="d-flex justify-content-end">
                                            ...
                                            <button type="submit" class="btn btn-sm btn-primary"
                                                data-kt-menu-dismiss="true" id="apply_filter">Apply</button>
                                        </div>
                                        <!--end::Actions-->
                                    </div>
                                    <!--end::Form-->
                            ...
                            <div id="kt_datatable_export_menu"
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{route(Auth::user()->role . '.application.export', 'excel')}}"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{route(Auth::user()->role . '.application.export', 'csv')}}"
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="{{route(Auth::user()->role . '.application.export', 'pdf')}}"
