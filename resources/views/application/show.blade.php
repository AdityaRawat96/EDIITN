    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <button class="btn btn-primary btn-small" type="button" data-bs-toggle="modal" data-bs-target="#kt_create_modal">Notify</button>
                @if($application->status == 'processing')
                <div class="ml-5">
                    <form action="{{route('admin.application.update', $application->id)}}" method="POST">
                        @csrf
                        <input type="hidden" name="status" value="approved">
                        <button class="btn btn-success btn-small" type="button" onclick="handleStatusUpdate('approve', '{{$application->app_no}}')">Approve</button>
                        <button class="btn btn-danger btn-small" type="button" onclick="handleStatusUpdate('reject', '{{$application->app_no}}')">Reject</button>
                    </form>
                </div>
                @endif
                @endif
        ...
        <div id="kt_app_content_container" class="app-container container-xxl student_dashboard">
            <div class="row">
                            ...
                            <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                                ...
                                <div class="me-7 mb-4">
                                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                        <img src="{{isset($user->avatar) ? asset('storage/'.$user->avatar) : asset('media/svg/avatars/blank.svg')}}" alt="image" />
                                    </div>
                                </div>
                                <!--end::Pic-->
                                <!--begin::Info-->
                                    ...
                                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2 mt-5">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">{{$user->first_name}}
                ...
                <div class="col-md-12 col-lg-4">
                    ...
                    ?>
                    <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-center border-0 mb-5 mb-xl-10 {{$background}}" style="background-image: url('{{asset(`/media/svg/shapes/top-green.png`)}}">
                        <!--begin::Header-->
                        <div class="card-header pt-5">
                            ...
                            <div class="card-title d-flex flex-column">
                                ...
                                <!--end::Subtitle-->
                                <!--begin::Amount-->
                                <span class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">{{$user->application->app_no}}</span>
                                <!--end::Amount-->
                            </div>
                            <!--end::Title-->
                        </div>
                        ...
                        <div class="card-body d-flex pt-0">
                            ...
                            <div class="d-flex align-items-end justify-content-end h-100 flex-column mt-3 w-100">
                                <a href="{{route('student.application.edit', $user->application->id)}}" class="btn bg-white text-dark">Complete Application</a>
                            </div>
                            @else
                            <!--begin::Progress-->
                            <div class="d-flex align-items-center flex-column mt-3 w-100">
                                ...
                                <div class="h-8px mx-3 w-100 bg-light-danger rounded">
                                    <div class="bg-info rounded h-8px" role="progressbar" style="width: 0%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <!--end::Progress-->
                            @endif
                            ...
                            <div class="d-flex align-items-center flex-column mt-3 w-100">
                                ...
                                <div class="h-8px mx-3 w-100 bg-light-danger rounded">
                                    <div class="bg-info rounded h-8px" role="progressbar" style="width: 50%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <!--end::Progress-->
                            ...
                            <div class="d-flex align-items-center flex-column mt-3 w-100">
                                ...
                                <div class="h-8px mx-3 w-100 bg-light-danger rounded">
                                    <div class="bg-info rounded h-8px" role="progressbar" style="width: 100%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                            <!--end::Progress-->
