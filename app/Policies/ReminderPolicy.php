...
class ReminderPolicy
{
    ...
    {
        // only allow the user to view the list of reminders if they have role of admin or student
    ...
    {
        // only allow the reminder to view the list of reminders if they have role of admin or student
        return $user->role === 'admin' || $user->role === 'student';
    }
    ...
    {
        // only allow the user to store a new reminder if they have role of admin or student
        return $user->role === 'admin' || $user->role === 'student';
    }
