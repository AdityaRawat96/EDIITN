...
class RefundPolicy
{
    ...
    {
        // only allow the user to view the list of refunds if they have role of admin or student
    ...
    {
        // only allow the user to store a new refund if they have role of admin or student
        return $user->role === 'admin' || $user->role === 'student';
    }
