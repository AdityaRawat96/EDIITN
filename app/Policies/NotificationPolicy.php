...
class NotificationPolicy
{
    ...
    {
        // only allow the user to view the list of notifications if they have role of admin or student
    ...
    {
        // only allow the notification to view the list of notifications if they have role of admin or student
        return $user->role === 'admin' || $user->role === 'student';
    }
