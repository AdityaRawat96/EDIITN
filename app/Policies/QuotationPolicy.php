...
class QuotationPolicy
{
    ...
    {
        // only allow the user to view the list of quotations if they have role of admin or student
    ...
    {
        // only allow the user to store a new quotation if they have role of admin or student
        return $user->role === 'admin' || $user->role === 'student';
    }
