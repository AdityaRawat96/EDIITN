...
class QueryPolicy
{
    ...
    {
        // only allow the user to view the list of queries if they have role of admin or student
    ...
    {
        // only allow the query to view the list of queries if they have role of admin or student
        return $user->role === 'admin' || $user->role === 'student';
    }
